...
def test_required_fields_validation():
    ...
    assert validator.validate({
        "decision": "BUY",
        "confidence": "high"
    }, dummy_policy, dummy_behavioural_flags, dummy_response_contract) == (True, '')
    
    # Missing required field
    assert validator.validate({
        "decision": "BUY"
    }, dummy_policy, dummy_behavioural_flags, dummy_response_contract) == (False, 'missing required fields')
